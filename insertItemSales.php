            ...
            <table>
                ...
                <?php
                    ...
                    if(mysqli_connect_errno()){
                        ...
                        $sql = "INSERT into itemSales (iIdentifier,oIdentifier,iOutletSales,iVisibility,iMrp) values ('".$_POST["iIdentifier"]."','".$_POST["oIdentifier"]."','".$_POST["iOutletSales"]."','".$_POST["iVisibility"]."','".$_POST["iMrp"]."');";
                        $res=mysqli_query($mysqli,$sql);
                        if($res==TRUE){
                            $sql = "SELECT * FROM itemSales WHERE iIdentifier='".$_POST['iIdentifier']."' AND oIdentifier='".$_POST['oIdentifier']."';";
                            $res = mysqli_query($mysqli, $sql);
